...
For more details on how it works, see [the implementation details](/docs/reference/compiler).
...
For more details, see [the implementation details](/docs/reference/vm).
